...
class Menu():
    def __init__(self, game_instance):
        ...
        goal = "The goal of this game is to assemble a secret code. The code is in the form of a sentence. " \
                   "To find the code, first collect objects. Then, put them in the right order to make words. " \
                    "Finally, put the words in the right order."
        quit = "To exit the game, close the window using the X button. To resize the window, click on the edges and drag."
        ...
        pick = "Moving over an object picks it up. You can carry up to 12 objects at a time." \
               "To see your and use picked objects, press the space key to go to the workspace window. " \
               "To go back to the playground, press a."
        ...
        code_words = "To see your guessed code words, press w to go to the winning window. Here, you can put the code words in the " \
                     ...
                     "part of the instructions each word carries. Press e to go back to the playground."
        ...
        end = "To see the instructions during the game, press i. To start playing, press s."
        self.instructions = [start, goal, quit,move,pick,compose,compose2,words,code_words,cheating,end]
